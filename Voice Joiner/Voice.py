...
|  $$ / $$//$$__  $$| $$ /$$_____/ /$$__  $$            | $$ /$$__  $$| $$| $$__  $$ /$$__  $$ /$$__  $$
 \  $$ $$/| $$  \ $$| $$| $$      | $$$$$$$$       /$$  | $$| $$  \ $$| $$| $$  \ $$| $$$$$$$$| $$  \__/
  \  $$$/ | $$  | $$| $$| $$      | $$_____/      | $$  | $$| $$  | $$| $$| $$  | $$| $$_____/| $$      
   \  $/  |  $$$$$$/| $$|  $$$$$$$|  $$$$$$$      |  $$$$$$/|  $$$$$$/| $$| $$  | $$|  $$$$$$$| $$      
    \_/    \______/ |__/ \_______/ \_______/       \______/  \______/ |__/|__/  |__/ \_______/|__/      
...
Write.Print("\nNe Seçmek İstersiniz: ", Colors.red)

Write.Print("\n> 1 - Voice Joiner ", Colors.red)





askim = int(input("\Seçim: "))


if askim == 1:
    print("Tokenlerinizi Tokens.txt'e koymayı unutmayın")

    with open("tokens.txt", "r") as token_file:
        tokens = token_file.readlines()
        server_id = input("Sunucu ID: ")
    ...
    os.system(f"Toplam Token: {len(tokenlist)}")
    i = 0
